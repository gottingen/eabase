...
#ifndef FIBER_LIST_OF_ABAFREE_ID_H_
#define FIBER_LIST_OF_ABAFREE_ID_H_
...
// an issue in current usages throughout eabase.
...
private:
    EA_DISALLOW_COPY_AND_ASSIGN(ListOfABAFreeId);
    struct IdBlock {
...
#endif  // FIBER_LIST_OF_ABAFREE_ID_H_
