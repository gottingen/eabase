...
#ifndef FIBER_TASK_META_H_
#define FIBER_TASK_META_H_

#include <pthread.h>                 // pthread_spin_init
#include "eabase/fiber/butex.h"           // butex_construct/destruct
#include "eabase/utility/atomicops.h"          // eabase::atomic
#include "eabase/fiber/types.h"           // fiber_attr_t
#include "eabase/fiber/stack.h"           // ContextualStack
...
struct TaskMeta {
    // [Not Reset]
    eabase::atomic<ButexWaiter*> current_waiter;
