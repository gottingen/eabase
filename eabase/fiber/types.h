...
#include "eabase/utility/logging.h"                      // CHECK
#endif
...
// fiber_session_t returned by fiber_session_create* can never be this value.
// NOTE: don't confuse with INVALID_FIBER!
static const fiber_session_t INVALID_FIBER_SESSION = {0};
