...
#include <eabase/rapidjson/reader.h>
#include <eabase/rapidjson/internal/meta.h>
#include <eabase/rapidjson/internal/strfunc.h>
#include <eabase/rapidjson/memorystream.h>
#include <eabase/rapidjson/encodedstream.h>
...
// TypeHelper
    ...
    namespace internal {
        ...
        struct TypeHelper<ValueType, uint64_t> {
            ...
            static ValueType &
            Set(ValueType &v, uint64_t data, typename ValueType::AllocatorType &) { return v.SetUint64(data); }
        };
...
*/
    ...
    public:
        ...
        template<typename SourceAllocator>
        MemberIterator
        FindMember(const GenericValue<EncodingType, SourceAllocator> &name) const { return value_.FindMember(name); }
        ...
        template<typename T>
        RAPIDJSON_DISABLEIF_RETURN((internal::OrExpr<internal::IsPointer<T>, internal::IsGenericValue<T> >),
                                   (ValueType & )) AddMember(ValueType &name, T value, AllocatorType &allocator) const {
            value_.AddMember(name, value, allocator);
            return *this;
        }
