 ...
 *  */
    template<typename OutputStream, typename SourceEncoding = UTF8<>,
            typename TargetEncoding = UTF8<>, typename StackAllocator = CrtAllocator, unsigned writeFlags = kWriteDefaultFlags>
    ...
    protected:
        bool WriteString(const Ch *str, SizeType length) {
            ...
            if (TargetEncoding::supportUnicode && std::is_same<SourceEncoding, TargetEncoding>::value) {
