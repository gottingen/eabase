...
#include <eabase/rapidjson/pointer.h>
...
#define RAPIDJSON_STRING_(name, ...) \
    static const ValueType& Get##name##String() {\
        ...
        return v;\
            ...
            RAPIDJSON_STRING_(PatternProperties, 'p', 'a', 't', 't', 'e', 'r', 'n', 'P', 'r', 'o', 'p', 'e', 'r', 't',
                              'i', 'e', 's')

            RAPIDJSON_STRING_(AdditionalProperties, 'a', 'd', 'd', 'i', 't', 'i', 'o', 'n', 'a', 'l', 'P', 'r', 'o',
                              'p', 'e', 'r', 't', 'i', 'e', 's')
            ...
            RAPIDJSON_STRING_(AdditionalItems, 'a', 'd', 'd', 'i', 't', 'i', 'o', 'n', 'a', 'l', 'I', 't', 'e', 'm',
                              's')
            ...
            RAPIDJSON_STRING_(ExclusiveMinimum, 'e', 'x', 'c', 'l', 'u', 's', 'i', 'v', 'e', 'M', 'i', 'n', 'i', 'm',
                              'u', 'm')

            RAPIDJSON_STRING_(ExclusiveMaximum, 'e', 'x', 'c', 'l', 'u', 's', 'i', 'v', 'e', 'M', 'a', 'x', 'i', 'm',
                              'u', 'm')
...
#undef RAPIDJSON_STRING_
        ...
        private:
            ...
            static const SchemaType *GetTypeless() {
                static SchemaType typeless(0, PointerType(), ValueType(kObjectType).Move(),
                                           ValueType(kObjectType).Move(), 0);
                return &typeless;
            }
...
*/
    ...
    public:
        ...
        */
        explicit GenericSchemaDocument(const ValueType &document, IRemoteSchemaDocumentProviderType *remoteProvider = 0,
...
#undef RAPIDJSON_SCHEMA_HANDLE_VALUE_
        ...
        virtual ISchemaValidator *CreateSchemaValidator(const SchemaType &root) {
            return new(GetStateAllocator().Malloc(sizeof(GenericSchemaValidator))) GenericSchemaValidator(
                    *schemaDocument_, root,
#if RAPIDJSON_SCHEMA_VERBOSE
                    depth_ + 1,
#endif
                    &GetStateAllocator());
        ...
        bool EndValue() {
            ...
            *documentStack_.template Push<Ch>() = '\0';
            ...
            uint64_t h = CurrentContext().arrayUniqueness
                         ? static_cast<HasherType *>(CurrentContext().hasher)->GetHashCode() : 0;
