...
class StaticAtomicSequenceNumber {
 public:
  inline int GetNext() {
    return static_cast<int>(
        eabase::subtle::NoBarrier_AtomicIncrement(&seq_, 1) - 1);
  }
 ...
 private:
  ...
  inline void Reset() {
    eabase::subtle::Release_Store(&seq_, 0);
  }

  eabase::subtle::Atomic32 seq_;
};
...
class AtomicSequenceNumber {
 ...
 private:
  ...
  EA_DISALLOW_COPY_AND_ASSIGN(AtomicSequenceNumber);
};
