...
#include "eabase/utility/atomicops_internals_tsan.h"
#elif defined(OS_WIN) && defined(COMPILER_MSVC) && defined(ARCH_CPU_X86_FAMILY)
#include "eabase/utility/atomicops_internals_x86_msvc.h"
#elif defined(OS_MACOSX)
#include "eabase/utility/atomicops_internals_mac.h"
#elif defined(OS_NACL)
#include "eabase/utility/atomicops_internals_gcc.h"
#elif defined(COMPILER_GCC) && defined(ARCH_CPU_ARMEL)
#include "eabase/utility/atomicops_internals_arm_gcc.h"
#elif defined(COMPILER_GCC) && defined(ARCH_CPU_ARM64)
#include "eabase/utility/atomicops_internals_arm64_gcc.h"
#elif defined(COMPILER_GCC) && defined(ARCH_CPU_X86_FAMILY)
#include "eabase/utility/atomicops_internals_x86_gcc.h"
#elif defined(COMPILER_GCC) && defined(ARCH_CPU_MIPS_FAMILY)
#include "eabase/utility/atomicops_internals_mips_gcc.h"
#elif defined(COMPILER_GCC) && defined(ARCH_CPU_LOONGARCH64_FAMILY)
#include "eabase/utility/atomicops_internals_loongarch64_gcc.h"
#else
...
#include "eabase/utility/atomicops_internals_atomicword_compat.h"
#endif

// ========= Provide eabase::atomic<T> =========
...
private:
    EA_DISALLOW_COPY_AND_ASSIGN(atomic);
...
private:
    ...
    // are same so that different compilation units seeing different 
    // definitions(enable C++11 or not) should be compatible.
    static_assert(sizeof(T) == sizeof(::boost::atomic<T>), "size_must_match");
};
} // namespace eabase
#endif
