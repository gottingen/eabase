...
#define OS_QNX 1
#else
#error Please add support for your platform in eabase/utility/build_config.h
#endif
...
#else
#error Please add support for your compiler in eabase/utility/build_config.h
#endif
...
#define ARCH_CPU_LITTLE_ENDIAN 1
#else
#error Please add support for your architecture in eabase/utility/build_config.h
#endif
...
// The compiler thinks eabase::string16::const_iterator and "char16*" are
// equivalent types.
