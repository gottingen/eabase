...
struct CaseIgnoredEqual {
    // NOTE: No overload for eabase::StringPiece. It needs strncasecmp
...
template <typename T>
class CaseIgnoredFlatMap : public eabase::FlatMap<
    std::string, T, CaseIgnoredHasher, CaseIgnoredEqual> {};

class CaseIgnoredFlatSet : public eabase::FlatSet<
