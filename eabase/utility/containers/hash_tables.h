...
// of hash_map. Allows all platforms to use |eabase::hash_map| and
// |eabase::hash_set|.
//  eg:
//   eabase::hash_map<int, std::string> my_map;
//   eabase::hash_set<int> my_set;
//
...
DEFINE_STRING_HASH(eabase::string16);
...
inline std::size_t hash_value(const std::pair<Type1, Type2>& value) {
  return eabase::HashPair(value.first, value.second);
}
