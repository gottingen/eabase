...
class MRUCacheBase {
 ...
 private:
  ...
  EA_DISALLOW_COPY_AND_ASSIGN(MRUCacheBase);
};
...
class MRUCache : public MRUCacheBase<KeyType,
 ...
 private:
  EA_DISALLOW_COPY_AND_ASSIGN(MRUCache);
};
...
class OwningMRUCache
 ...
 private:
  EA_DISALLOW_COPY_AND_ASSIGN(OwningMRUCache);
};
...
struct MRUCacheHashMap {
  typedef eabase::hash_map<KeyType, ValueType> Type;
};

// This class is similar to MRUCache, except that it uses eabase::hash_map as
...
class HashingMRUCache : public MRUCacheBase<KeyType,
 ...
 private:
  EA_DISALLOW_COPY_AND_ASSIGN(HashingMRUCache);
};
