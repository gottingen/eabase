...
// eabase::hash_map. The ScopedPtrHashMap has ownership of all values in the data
// structure.
template <typename Key, typename Value>
class ScopedPtrHashMap {
  typedef eabase::hash_map<Key, Value*> Container;
 ...
 private:
  ...
  EA_DISALLOW_COPY_AND_ASSIGN(ScopedPtrHashMap);
};
