...
class StackAllocator : public std::allocator<T> {
 public:
  ...
  struct Source {
    ...
    eabase::AlignedMemory<sizeof(T[stack_capacity]), ALIGNOF(T)> stack_buffer_;
...
class StackContainer {
 ...
 protected:
  ...
  EA_DISALLOW_COPY_AND_ASSIGN(StackContainer);
};
...
class StackString : public StackContainer<
 ...
 private:
  EA_DISALLOW_COPY_AND_ASSIGN(StackString);
};
...
class StackString16 : public StackContainer<
 ...
 private:
  EA_DISALLOW_COPY_AND_ASSIGN(StackString16);
};
