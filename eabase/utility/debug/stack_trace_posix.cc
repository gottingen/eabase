...
void DemangleSymbols(std::string* text) {
  ...
  while (search_from < text->size()) {
    ...
    int status = 0;
    scoped_ptr<char, eabase::FreeDeleter> demangled_symbol(
...
class PrintBacktraceOutputHandler : public BacktraceOutputHandler {
 ...
 private:
  EA_DISALLOW_COPY_AND_ASSIGN(PrintBacktraceOutputHandler);
};
...
class StreamBacktraceOutputHandler : public BacktraceOutputHandler {
 ...
 private:
  ...
  EA_DISALLOW_COPY_AND_ASSIGN(StreamBacktraceOutputHandler);
};
...
void WarmUpBacktrace() {
  ...
  // #20 0x0000000000752a54 in eabase::debug::StackTrace::StackTrace
  //             at eabase/utility/debug/stack_trace_posix.cc:175
  // #21 0x00000000007a4ae5 in
  //             eabase::(anonymous namespace)::StackDumpSignalHandler
  //             at eabase/utility/process_util_posix.cc:172
...
// (eabase/utility/third_party/symbolize/symbolize.h) so that it can function properly
...
#define O_CLOEXEC 02000000
  ...
  EA_DISALLOW_COPY_AND_ASSIGN(SandboxSymbolizeHelper);
};
#endif  // USE_SYMBOLIZE
...
StackTrace::StackTrace() {
  ...
  if (GetStackTrace) {
      ...
      count_ = eabase::saturated_cast<size_t>(backtrace(trace_, arraysize(trace_)));
#else
      count_ = 0;
#endif
  }
