...
#if defined(OS_POSIX)
#include "eabase/utility/file_descriptor_posix.h"
...
BUTIL_EXPORT bool VerifyPathControlledByUser(const eabase::FilePath& base,
                                            const eabase::FilePath& path,
                                            uid_t owner_uid,
...
BUTIL_EXPORT bool VerifyPathControlledByAdmin(const eabase::FilePath& path);
#endif  // defined(OS_MACOSX) && !defined(OS_IOS)

// Returns the maximum length of path component on the volume containing
// the directory |path|, in the number of FilePath::CharType, or -1 on failure.
BUTIL_EXPORT int GetMaximumPathComponentLength(const eabase::FilePath& path);
