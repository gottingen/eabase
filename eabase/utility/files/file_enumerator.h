...
// Example:
//
//   eabase::FileEnumerator enum(my_dir, false, eabase::FileEnumerator::FILES,
//                             FILE_PATH_LITERAL("*.txt"));
//   for (eabase::FilePath name = enum.Next(); !name.empty(); name = enum.Next())
//     ...
class BUTIL_EXPORT FileEnumerator {
 ...
 private:
  ...
  EA_DISALLOW_COPY_AND_ASSIGN(FileEnumerator);
};
