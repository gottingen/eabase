...
#include "eabase/utility/scoped_generic.h"
...
// FD (like sockets).
//
// If you're writing low-level Windows code, see eabase/utility/win/scoped_handle.h
// which provides some additional functionality.
//
// If you're writing cross-platform code that deals with actual files, you
// should generally use eabase::File instead which can be constructed with a
