...
#include "eabase/utility/debug/leak_annotations.h"
...
// eabase::LazyInstance<T>::Leaky my_leaky_lazy_instance;
// instead of:
// eabase::LazyInstance<T, eabase::internal::LeakyLazyInstanceTraits<T> >
...
class LazyInstance {
 public:
  ...
  eabase::AlignedMemory<sizeof(Type), ALIGNOF(Type)> private_buf_;
