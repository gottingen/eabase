...
#ifndef BUTIL_MAC_SCOPED_CFTYPEREF_H_
#define BUTIL_MAC_SCOPED_CFTYPEREF_H_

#include <CoreFoundation/CoreFoundation.h>

#include "eabase/utility/mac/scoped_typeref.h"
...
class ScopedCFTypeRef
 ...
 public:
  ...
  explicit ScopedCFTypeRef(
      CFT object = NULL,
      eabase::scoped_policy::OwnershipPolicy policy = eabase::scoped_policy::ASSUME)
      : ScopedTypeRef<CFT,
...
#endif  // BUTIL_MAC_SCOPED_CFTYPEREF_H_
