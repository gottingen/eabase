...
class BUTIL_EXPORT RefCountedMemory
    : public eabase::RefCountedThreadSafe<RefCountedMemory> {
 public:
 ...
 protected:
  friend class eabase::RefCountedThreadSafe<RefCountedMemory>;
  RefCountedMemory();
...
class BUTIL_EXPORT RefCountedStaticMemory : public RefCountedMemory {
 ...
 private:
  ...
  EA_DISALLOW_COPY_AND_ASSIGN(RefCountedStaticMemory);
};
...
class BUTIL_EXPORT RefCountedBytes : public RefCountedMemory {
 ...
 private:
  ...
  EA_DISALLOW_COPY_AND_ASSIGN(RefCountedBytes);
};
...
class BUTIL_EXPORT RefCountedString : public RefCountedMemory {
 ...
 private:
  ...
  EA_DISALLOW_COPY_AND_ASSIGN(RefCountedString);
};
...
// using free().
class BUTIL_EXPORT RefCountedMallocedMemory : public eabase::RefCountedMemory {
 public:
 ...
 private:
  ...
  EA_DISALLOW_COPY_AND_ASSIGN(RefCountedMallocedMemory);
};
