...
public:
    static eabase::subtle::AtomicWord g_leaky_singleton_untyped;
    static pthread_once_t g_create_leaky_singleton_once;
    static void create_leaky_singleton();
};
template <typename T>
eabase::subtle::AtomicWord GetLeakySingleton<T>::g_leaky_singleton_untyped = 0;
...
void GetLeakySingleton<T>::create_leaky_singleton() {
    ...
    eabase::subtle::Release_Store(
        ...
        reinterpret_cast<eabase::subtle::AtomicWord>(obj));
}
...
inline T* get_leaky_singleton() {
    const eabase::subtle::AtomicWord value = eabase::subtle::Acquire_Load(
