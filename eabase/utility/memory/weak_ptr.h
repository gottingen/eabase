...
class BUTIL_EXPORT WeakReference {
 public:
  ...
  class BUTIL_EXPORT Flag : public RefCountedThreadSafe<Flag> {
   ...
   private:
    friend class eabase::RefCountedThreadSafe<Flag>;
...
class SupportsWeakPtrBase {
 public:
  ...
  // from SupportsWeakPtr<Base>. See eabase::AsWeakPtr() below for a helper
...
class SupportsWeakPtr : public internal::SupportsWeakPtrBase {
 ...
 private:
  internal::WeakReferenceOwner weak_reference_owner_;
  EA_DISALLOW_COPY_AND_ASSIGN(SupportsWeakPtr);
};
...
//
// EXAMPLE:
//   class Base : public eabase::SupportsWeakPtr<Producer> {};
//   class Derived : public Base {};
//
//   Derived derived;
//   eabase::WeakPtr<Derived> ptr = eabase::AsWeakPtr(&derived);
//
...
// the caller.
//
//   eabase::WeakPtr<Derived> ptr = derived.AsWeakPtr();  // Fails.
