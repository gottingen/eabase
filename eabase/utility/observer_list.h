...
class ObserverListBase
    : public eabase::SupportsWeakPtr<ObserverListBase<ObserverType> > {
 public:
  ...
  class Iterator {
   ...
   private:
    eabase::WeakPtr<ObserverListBase<ObserverType> > list_;
    size_t index_;
    size_t max_index_;
  };
 ...
 private:
  ...
  EA_DISALLOW_COPY_AND_ASSIGN(ObserverListBase);
};
