...
//   eabase::InjectiveMultimap file_descriptor_map;
//   file_descriptor_map.push_back(eabase::InjectionArc(devnull, 0, true));
//   file_descriptor_map.push_back(eabase::InjectionArc(devnull, 2, true));
//   file_descriptor_map.push_back(eabase::InjectionArc(pipe[1], 1, true));
//   eabase::ShuffleFileDescriptors(file_descriptor_map);
//
