...
#include "eabase/utility/strings/string_split.h"
...
void SplitString(const eabase::StringPiece16& str,
                 char16 c,
...
bool SplitStringIntoKeyValuePairs(const eabase::StringPiece& line,
                                  char key_value_delimiter,
                                  char key_value_pair_delimiter,
...
void SplitStringUsingSubstr(const eabase::StringPiece16& str,
...
void SplitStringUsingSubstr(const eabase::StringPiece& str,
...
void SplitStringDontTrim(const eabase::StringPiece16& str,
                         char16 c,
                         std::vector<eabase::StringPiece16>* r) {
  DCHECK(CBU16_IS_SINGLE(c));
  SplitStringT(str, c, false, r);
...
void SplitStringDontTrim(const eabase::StringPiece& str,
                         char c,
                         std::vector<eabase::StringPiece>* r) {
  DCHECK(IsStringUTF8(str));
#if CHAR_MIN < 0
...
void SplitStringAlongWhitespace(const eabase::StringPiece16& str,
...
void SplitStringAlongWhitespace(const eabase::StringPiece& str,
