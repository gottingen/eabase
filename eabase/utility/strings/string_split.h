...
BUTIL_EXPORT void SplitString(const eabase::StringPiece16& str,
                             char16 c,
                             std::vector<eabase::StringPiece16>* r);
...
BUTIL_EXPORT void SplitString(const eabase::StringPiece& str,
                             char c,
                             std::vector<eabase::StringPiece>* r);

typedef std::vector<std::pair<std::string, std::string> > StringPairs;
typedef std::vector<std::pair<eabase::StringPiece, eabase::StringPiece> > StringPiecePairs;
...
BUTIL_EXPORT bool SplitStringIntoKeyValuePairs(const eabase::StringPiece& line,
                                              char key_value_delimiter,
                                              char key_value_pair_delimiter,
...
BUTIL_EXPORT void SplitStringUsingSubstr(const string16& str,
                                        const string16& s,
                                        std::vector<string16>* r);
BUTIL_EXPORT void SplitStringUsingSubstr(const eabase::StringPiece16& str,
                                        const eabase::StringPiece16& s,
                                        std::vector<eabase::StringPiece16>* r);
BUTIL_EXPORT void SplitStringUsingSubstr(const std::string& str,
                                        const std::string& s,
                                        std::vector<std::string>* r);
BUTIL_EXPORT void SplitStringUsingSubstr(const eabase::StringPiece& str,
                                        const eabase::StringPiece& s,
                                        std::vector<eabase::StringPiece>* r);
...
BUTIL_EXPORT void SplitStringDontTrim(const string16& str,
                                     char16 c,
                                     std::vector<string16>* r);
BUTIL_EXPORT void SplitStringDontTrim(const eabase::StringPiece16& str,
                                     char16 c,
                                     std::vector<eabase::StringPiece16>* r);
// |str| should not be in a multi-byte encoding like Shift-JIS or GBK in which
// the trailing byte of a multi-byte character can be in the ASCII range.
...
BUTIL_EXPORT void SplitStringDontTrim(const std::string& str,
                                     char c,
                                     std::vector<std::string>* r);
BUTIL_EXPORT void SplitStringDontTrim(const eabase::StringPiece& str,
                                     char c,
                                     std::vector<eabase::StringPiece>* r);
...
BUTIL_EXPORT void SplitStringAlongWhitespace(const eabase::StringPiece16& str,
                                            std::vector<eabase::StringPiece16>* result);
BUTIL_EXPORT void SplitStringAlongWhitespace(const std::string& str,
                                            std::vector<std::string>* result);
BUTIL_EXPORT void SplitStringAlongWhitespace(const eabase::StringPiece& str,
                                            std::vector<eabase::StringPiece>* result);
