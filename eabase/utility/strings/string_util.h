...
#include "eabase/utility/strings/string16.h"
#include "eabase/utility/strings/string_piece.h"  // For implicit conversions.

namespace eabase {

// C standard-library functions like "strncasecmp" and "snprintf" that aren't
// cross-platform are provided as "eabase::strncasecmp", and their prototypes
...
//
// This function is intended to be called from eabase::vswprintf.
...
BUTIL_EXPORT bool RemoveChars(const string16& input,
                             const eabase::StringPiece16& remove_chars,
                             string16* output);
BUTIL_EXPORT bool RemoveChars(const std::string& input,
                             const eabase::StringPiece& remove_chars,
                             std::string* output);
...
BUTIL_EXPORT bool ReplaceChars(const string16& input,
                              const eabase::StringPiece16& replace_chars,
                              const string16& replace_with,
                              string16* output);
BUTIL_EXPORT bool ReplaceChars(const std::string& input,
                              const eabase::StringPiece& replace_chars,
...
BUTIL_EXPORT bool TrimString(const string16& input,
                            const eabase::StringPiece16& trim_chars,
                            string16* output);
BUTIL_EXPORT bool TrimString(const std::string& input,
                            const eabase::StringPiece& trim_chars,
                            std::string* output);
...
BUTIL_EXPORT TrimPositions TrimWhitespace(const string16& input,
                                         ...
                                         eabase::string16* output);
BUTIL_EXPORT TrimPositions TrimWhitespace(const eabase::StringPiece16& input,
                                         TrimPositions positions,
                                         eabase::StringPiece16* output);
BUTIL_EXPORT TrimPositions TrimWhitespaceASCII(const std::string& input,
                                              TrimPositions positions,
                                              std::string* output);
BUTIL_EXPORT TrimPositions TrimWhitespaceASCII(const eabase::StringPiece& input,
                                              TrimPositions positions,
                                              eabase::StringPiece* output);
...
BUTIL_EXPORT TrimPositions TrimWhitespace(const std::string& input,
                                         TrimPositions positions,
                                         std::string* output);
BUTIL_EXPORT TrimPositions TrimWhitespace(const eabase::StringPiece& input,
                                         TrimPositions positions,
                                         eabase::StringPiece* output);
...
#if defined(OS_WIN)
#include "eabase/utility/strings/string_util_win.h"
#elif defined(OS_POSIX)
#include "eabase/utility/strings/string_util_posix.h"
#else
...
BUTIL_EXPORT bool LowerCaseEqualsASCII(const eabase::string16& a, const char* b);

// Same thing, but with string iterators instead.
BUTIL_EXPORT bool LowerCaseEqualsASCII(std::string::const_iterator a_begin,
                                      std::string::const_iterator a_end,
                                      const char* b);
BUTIL_EXPORT bool LowerCaseEqualsASCII(eabase::string16::const_iterator a_begin,
                                      eabase::string16::const_iterator a_end,
                                      const char* b);
BUTIL_EXPORT bool LowerCaseEqualsASCII(const char* a_begin,
                                      const char* a_end,
                                      const char* b);
BUTIL_EXPORT bool LowerCaseEqualsASCII(const eabase::char16* a_begin,
                                      const eabase::char16* a_end,
                                      const char* b);

// Performs a case-sensitive string compare. The behavior is undefined if both
// strings are not ASCII.
BUTIL_EXPORT bool EqualsASCII(const eabase::string16& a, const eabase::StringPiece& b);

// Returns true if str starts with search, or false otherwise.
BUTIL_EXPORT bool StartsWithASCII(const std::string& str,
                                 const std::string& search,
                                 bool case_sensitive);
BUTIL_EXPORT bool StartsWith(const eabase::string16& str,
                            const eabase::string16& search,
                            bool case_sensitive);
...
BUTIL_EXPORT bool EndsWith(const std::string& str,
                          const std::string& search,
                          bool case_sensitive);
BUTIL_EXPORT bool EndsWith(const eabase::string16& str,
                          const eabase::string16& search,
                          bool case_sensitive);
...
inline bool IsWhitespace(wchar_t c) {
  return wcschr(eabase::kWhitespaceWide, c) != NULL;
}

inline bool IsBlankString(const eabase::StringPiece &s) {
    return eabase::ContainsOnlyChars(s, " \r\n\t");
}
...
BUTIL_EXPORT eabase::string16 FormatBytesUnlocalized(int64_t bytes);
...
BUTIL_EXPORT void ReplaceFirstSubstringAfterOffset(
    eabase::string16* str,
    size_t start_offset,
    const eabase::string16& find_this,
    const eabase::string16& replace_with);
BUTIL_EXPORT void ReplaceFirstSubstringAfterOffset(
    std::string* str,
    size_t start_offset,
...
BUTIL_EXPORT size_t Tokenize(const eabase::string16& str,
                            const eabase::string16& delimiters,
                            std::vector<eabase::string16>* tokens);
BUTIL_EXPORT size_t Tokenize(const std::string& str,
                            const std::string& delimiters,
                            std::vector<std::string>* tokens);
BUTIL_EXPORT size_t Tokenize(const eabase::StringPiece& str,
                            const eabase::StringPiece& delimiters,
                            std::vector<eabase::StringPiece>* tokens);

// Does the opposite of SplitString().
BUTIL_EXPORT eabase::string16 JoinString(const std::vector<eabase::string16>& parts,
                                      eabase::char16 s);
...
BUTIL_EXPORT eabase::string16 JoinString(
    const std::vector<eabase::string16>& parts,
    const eabase::string16& separator);

// Replace $1-$2-$3..$9 in the format string with |a|-|b|-|c|..|i| respectively.
// Additionally, any number of consecutive '$' characters is replaced by that
// number less one. Eg $$->$, $$$->$$, etc. The offsets parameter here can be
// NULL. This only allows you to use up to nine replacements.
BUTIL_EXPORT eabase::string16 ReplaceStringPlaceholders(
    const eabase::string16& format_string,
    const std::vector<eabase::string16>& subst,
    std::vector<size_t>* offsets);

BUTIL_EXPORT std::string ReplaceStringPlaceholders(
    const eabase::StringPiece& format_string,
...
BUTIL_EXPORT bool MatchPattern(const eabase::StringPiece& string,
                              const eabase::StringPiece& pattern);
BUTIL_EXPORT bool MatchPattern(const eabase::string16& string,
                              const eabase::string16& pattern);
