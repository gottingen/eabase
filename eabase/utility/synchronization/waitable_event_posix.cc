...
void WaitableEvent::Reset() {
  eabase::AutoLock locked(kernel_->lock_);
...
bool WaitableEvent::TimedWait(const TimeDelta& max_time) {
  eabase::ThreadRestrictions::AssertWaitAllowed();
