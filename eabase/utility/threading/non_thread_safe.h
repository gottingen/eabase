...
//
// Example:
// class MyClass : public eabase::NonThreadSafe {
//  public:
//   void Foo() {
...
// }
//
// Note that eabase::ThreadChecker offers identical functionality to
// NonThreadSafe, but does not require inheritance. In general, it is preferable
// to have a eabase::ThreadChecker as a member, rather than inherit from
// NonThreadSafe. For more details about when to choose one over the other, see
// the documentation for eabase::ThreadChecker.
