...
//      eabase::ThreadRestrictions::SetIOAllowed(false);
 ...
 public:
  ...
  class BUTIL_EXPORT ScopedAllowIO {
   ...
   private:
    ...
    EA_DISALLOW_COPY_AND_ASSIGN(ScopedAllowIO);
  };
  ...
  class BUTIL_EXPORT ScopedAllowSingleton {
   ...
   private:
    ...
    EA_DISALLOW_COPY_AND_ASSIGN(ScopedAllowSingleton);
  };
...
public:
  ...
  class BUTIL_EXPORT ScopedAllowWait {
   ...
   private:
    ...
    EA_DISALLOW_COPY_AND_ASSIGN(ScopedAllowWait);
  };
