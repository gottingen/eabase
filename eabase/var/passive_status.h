...
#ifndef  EABASE_VAR_PASSIVE_STATUS_H_
#define  EABASE_VAR_PASSIVE_STATUS_H_
...
//
//   // number1 : 5
//   eabase::PassiveStatus<int> status1("number1", print_number, arg);
//
//   // foo_number2 : 5
//   eabase::PassiveStatus<int> status2("Foo", "number2", print_number, arg);
...
public:
    ...
    static const bool ADDITIVE = (eabase::is_integral<Tp>::value ||
                                  eabase::is_floating_point<Tp>::value ||
                                  is_vector<Tp>::value);
...
public:
    ...
    PassiveStatus(const eabase::StringPiece& name,
    ...
    PassiveStatus(const eabase::StringPiece& prefix,
...
public:
    BasicPassiveStatus(const eabase::StringPiece& name,
                       Tp (*getfn)(void*), void* arg)
        : PassiveStatus<Tp>(name, getfn, arg) {}
    
    BasicPassiveStatus(const eabase::StringPiece& prefix,
                       const eabase::StringPiece& name,
                       Tp (*getfn)(void*), void* arg)
...
#endif  // EABASE_VAR_PASSIVE_STATUS_H_
