...
#ifndef  EABASE_VAR_RECORDER_H_
#define  EABASE_VAR_RECORDER_H_
...
public:
    ...
    explicit IntRecorder(const eabase::StringPiece& name) : _sampler(NULL) {
        expose(name);
    }

    IntRecorder(const eabase::StringPiece& prefix, const eabase::StringPiece& name)
        : _sampler(NULL) {
