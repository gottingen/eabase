...
#ifndef  EABASE_VAR_VECTOR_H_
#define  EABASE_VAR_VECTOR_H_
...
template <typename T>
struct is_vector : public eabase::false_type {};

template <typename T, size_t N>
struct is_vector<Vector<T,N> > : public eabase::true_type {};

}  // namespace eabase

#endif  // EABASE_VAR_VECTOR_H_
