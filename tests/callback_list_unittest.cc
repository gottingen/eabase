...
#include "eabase/utility/callback_list.h"
...
class Listener {
 ...
 private:
  int total_;
  int scaler_;
  EA_DISALLOW_COPY_AND_ASSIGN(Listener);
};
...
class Remover {
 ...
 private:
  ...
  EA_DISALLOW_COPY_AND_ASSIGN(Remover);
};
...
class Adder {
 ...
 private:
  ...
  EA_DISALLOW_COPY_AND_ASSIGN(Adder);
};
...
class Summer {
 ...
 private:
  int value_;
  EA_DISALLOW_COPY_AND_ASSIGN(Summer);
};
