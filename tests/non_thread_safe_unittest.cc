...
#include "eabase/utility/threading/non_thread_safe.h"
#include "eabase/utility/threading/simple_thread.h"
#include <gtest/gtest.h>

// Duplicated from eabase/utility/threading/non_thread_safe.h so that we can be
...
class NonThreadSafeClass : public NonThreadSafe {
 ...
 private:
  EA_DISALLOW_COPY_AND_ASSIGN(NonThreadSafeClass);
};
...
class DeleteNonThreadSafeClassOnThread : public SimpleThread {
 ...
 private:
  ...
  EA_DISALLOW_COPY_AND_ASSIGN(DeleteNonThreadSafeClassOnThread);
};
