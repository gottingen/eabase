...
class SelfAssign : public eabase::RefCounted<SelfAssign> {
  friend class eabase::RefCounted<SelfAssign>;
...
class ScopedRefPtrToSelf : public eabase::RefCounted<ScopedRefPtrToSelf> {
 public:
 ...
 private:
  friend class eabase::RefCounted<ScopedRefPtrToSelf>;
