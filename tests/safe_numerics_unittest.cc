...
#include "eabase/utility/numerics/safe_conversions.h"
#include "eabase/utility/numerics/safe_math.h"
#include "eabase/utility/type_traits.h"
#include <gtest/gtest.h>

using std::numeric_limits;
using eabase::CheckedNumeric;
using eabase::checked_cast;
using eabase::saturated_cast;
using eabase::internal::MaxExponent;
using eabase::internal::RANGE_VALID;
using eabase::internal::RANGE_INVALID;
using eabase::internal::RANGE_OVERFLOW;
using eabase::internal::RANGE_UNDERFLOW;
using eabase::enable_if;
...
#define TEST_EXPECTED_RANGE(expected, actual)                                  \
  EXPECT_EQ(expected, eabase::internal::DstRangeRelationToSrcRange<Dst>(actual)) \
