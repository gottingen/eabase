...
TEST(StringUtilTest, SplitStringStringPiece) {
  ...
  SplitString(eabase::StringPiece(), ',', &r);
  EXPECT_EQ(0U, r.size());
  r.clear();

  SplitString(eabase::StringPiece("a,b,c"), ',', &r);
  ASSERT_EQ(3U, r.size());
  EXPECT_EQ(r[0], "a");
  EXPECT_EQ(r[1], "b");
  EXPECT_EQ(r[2], "c");
  ...
  SplitString(eabase::StringPiece("a,,c"), ',', &r);
  ASSERT_EQ(3U, r.size());
  EXPECT_EQ(r[0], "a");
  EXPECT_EQ(r[1], "");
  EXPECT_EQ(r[2], "c");
  ...
  SplitString(eabase::StringPiece("foo"), '*', &r);
  ASSERT_EQ(1U, r.size());
  EXPECT_EQ(r[0], "foo");
  r.clear();
  ...
  SplitString(eabase::StringPiece("\t\ta\t"), '\t', &r);
  ASSERT_EQ(4U, r.size());
  EXPECT_EQ(r[0], "");
  EXPECT_EQ(r[1], "");
  EXPECT_EQ(r[2], "a");
  ...
  SplitString(eabase::StringPiece("\ta\t\nb\tcc"), '\n', &r);
  ASSERT_EQ(2U, r.size());
  EXPECT_EQ(r[0], "a");
  EXPECT_EQ(r[1], "b\tcc");
  r.clear();
