...
namespace {
using eabase::IntRecorder;
using eabase::LatencyRecorder;
using eabase::utils::MutexWithRecorder;
using eabase::utils::MutexWithLatencyRecorder;
...
TEST_F(LockTimerTest, pthread_mutex_and_cond) {
    ...
    ASSERT_EQ(1u, recorder.count());
    {
        ...
        ASSERT_EQ(1u, recorder.count());
        timespec due_time = eabase::milliseconds_from_now(10);
        pthread_cond_t cond;
